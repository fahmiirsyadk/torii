        ...
        entries: vec![
            ...
            Entry::Assistant {
                ...
                lines: vec![
                    ...
                    "".into(),
                    "| Layer | Responsibility |".into(),
                    "| --- | --- |".into(),
                    "| Parser | Semantic Markdown events |".into(),
                    "| Pager | Selection and copy actions |".into(),
                    "".into(),
                    "> Raw Markdown remains available for exact copying.".into(),
                    "".into(),
                    "```rust".into(),
